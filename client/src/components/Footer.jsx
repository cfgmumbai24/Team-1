      ...
      <div className="row mt-4">
        ...
        <div className="col-lg-4 col-md-6 mb-4 mb-md-0">
          ...
          <ul className="fa-ul list-unstyled body-font">
            ...
            <li className="mb-3">
              <span className="fa-li"></span><span className="ms-2 body-font">info@example.com</span>
            </li>
            <li className="mb-3">
              <span className="fa-li"></span><span className="ms-2 body-font">+ 91 234 567 88</span>
            </li>
            <li className="mb-3">
              <span className="fa-li"></span><span className="ms-2 body-font">+ 91 234 567 89</span>
            </li>
          </ul>
        </div>
